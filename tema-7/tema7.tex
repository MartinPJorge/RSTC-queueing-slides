...
\begin{frame}{\secname: \subsecname}
    \begin{lema}[Ecuaciones equilibrio M/M/N]
        ...
        \begin{equation}
            \pi_i=\begin{cases}
                \frac{I^i}{i!}\pi_0, \quad&
                i\leq N\\
                \rho^i \frac{N^N}{N!}\pi_0,
                \quad& i\geq N
            \end{cases}
        \end{equation}
        con $I=\tfrac{\lambda}{\mu}$,
...
\begin{frame}{\secname: \subsecname}
    ...
    \begin{itemize}
        ...
        se tiene $\pi_1=I\pi_0$.
        Por tanto tenemos que
        \begin{align*}
            \lambda\pi_0+2\mu\pi_2=
            \pi_1(\lambda+\mu)
            \Longleftrightarrow&
            \pi_2=\frac{I^2}{2}\pi_0\\
            %
            \lambda\pi_1+3\mu\pi_3=
            \pi_2(\lambda+2\mu)
            \Longleftrightarrow&
            \pi_3=\frac{I^3}{3!}\pi_0\\
            \ldots\\
            \lambda\pi_{i-1}+(i+1)\mu\pi_{i+1}=
            \pi_i(\lambda+i\mu)
            \Longleftrightarrow&
            \pi_i=\frac{I^i}{i!}\pi_0\\
        \end{align*}
        y deducimos $\pi_i=\tfrac{I}{i}\pi_{i-1}$.
    \end{itemize}
\end{frame}
...
\begin{frame}{\secname: \subsecname}
    ...
    \begin{itemize}
        ...
        \begin{align*}
            ...
            \right)\\
        \end{align*}
        sustituyendo $\pi_{N-1}=\tfrac{I}{N-1}
...
\begin{frame}{\secname: \subsecname}
    ...
    \begin{itemize}
        ...
        \begin{equation*}
            ...
            \quad i\geq N
        \end{equation*}
        y si usamos $\pi_i=\tfrac{I^i}{i!}\pi_0$
        con $i\leq N$ obtenemos:
        \begin{align*}
            \pi_{i}=&\frac{I}{N}\pi_{i-1}
            =\frac{I^2}{N^2}\pi_{i-2}=
            \cdots
            = \left(
                \frac{I}{N}
            \right)^{i-N}
...
\begin{frame}{\secname: \subsecname}
    ...
    $I=\tfrac{\lambda}{\mu}=5$ me dicen que
...
\begin{frame}{\secname: \subsecname}
    \begin{lema}[Earlang-C]
        ...
        \begin{equation}
            E_C(N,I)=\mathbb{P}(N(t)\geq N)
            = \frac{I^N}{N!}\frac{1}{1-\rho}\pi_0
        \end{equation}
    \end{lema}
    \begin{figure}
        \resizebox{!}{.2\textwidth}{%
...
\begin{frame}{\secname: \subsecname}
    ...
    una intensidad de $I=3$ Earlangs necesitamos
