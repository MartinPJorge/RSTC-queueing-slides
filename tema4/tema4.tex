...
\author{\textcolor{white}{RSTC curso 2025-2026}}
...
\begin{frame}{\secname: \subsecname}
    \begin{lema}[Mínimo de v.a. exponenciales]
        Sean las variables aleatorias (v.a.) exponenciales
...
\begin{frame}{\secname: \subsecname}
    ...
    \begin{equation*}
        ...
        = (1-\rho)\rho \frac{d}{d\rho}\sum_{i=1}^\infty \rho^i = \ldots = \frac{\rho}{1-\rho}
    \end{equation*}
\end{frame}
