...
\begin{frame}{\secname: \subsecname}
    \textit{Ejemplo (cont.)}: TBD con números
\end{frame}
...
\begin{frame}{\secname: \subsecname}
    \textit{Ejemplo}: TBD, calcular tiempo
    de tránsito por ruta compleja y
    su probabilidad
\end{frame}
