...
\begin{problemlist}
    ...
    \begin{solucion}
        \input{../../RSTC-solutions/tema-5/solucion2026-problema1.tex}
    \end{solucion}
    ...
    \pbitem Encuentre el valor de $a$
        ...
        \begin{solucion}
            \input{../../RSTC-solutions/tema-5/solucion2026-problema2.tex}
        \end{solucion}
    ...
    \pbitem Suponga que el tiempo de servicio
        ...
        \begin{solucion}
            \input{../../RSTC-solutions/tema-5/solucion2026-problema3.tex}
        \end{solucion}
